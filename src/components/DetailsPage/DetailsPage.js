            ...
            <div className="flex flex-col h-full w-full bg-white rounded-xl p-6">
                <div className="flex flex-row items-center justify-between">
                    <div className="flex flex-row gap-2 items-center px-2">
                        ...
                        |
                        <div className="text-black text-md md:text-xl font-space-grotesk">
                            {workData.title}
                        </div>
                    </div>
                    <button onClick={onClose} className='p-3 rounded-full bg-red-400 hover:scale-105'>
                ...
                <div className="flex flex-col gap-1 bg-white p-1 md:p-3 group-hover:translate-y-4 duration-200">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="text-black text-md md:text-xl font-space-grotesk mb-2 font-medium">
                            {workData.title}
                        </div>
                    ...
                    <div className="text-lg font-bold text-darker-2 font-roboto mt-2">
                        Techs Used:
                    </div>
                    ...
                    <div className="flex flex-row gap-5 my-2">
                        {workData.tech_icons.map((tech) => {
                            return (
                                <img src={tech} title="React" alt="React" width="35" height="35"/>
                            );
                        })}
